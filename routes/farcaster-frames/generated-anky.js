...
router.get("/", async (req, res) => {
  try {
    ...
    <head>
      ...
      <meta property="og:image" content="https://jpfraneto.github.io/images/reveal.png">
      <meta name="fc:frame" content="vNext">
      <meta name="fc:frame:image" content="https://jpfraneto.github.io/images/reveal.png">
      <meta name="fc:frame:post_url" content="${fullUrl}/farcaster-frames/generated-anky?id=${router.query.id}&revealed=1">
