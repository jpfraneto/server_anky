...
const checkAndUpdateGeneratedAnkys = async () => {
  console.log("inside the check and update ankys");
  ...
  for (const anky of ankys) {
    try {
      ...
      if (apiData.status === "completed") {
        ...
        console.log("Final image uploaded to Cloudinary:", finalImageUrl);
        ...
        console.log("after ahdqkjaskjhcoias was shipped");
      } else if (apiData.status === "failed") {
