  ...
  for (const anky of ankys) {
    try {
      ...
      if (apiData.status === "completed") {
        ...
        let imageOneUrl, imageTwoUrl, imageThreeUrl, imageFourUrl;
        let imageUrls = [];
        ...
        // NOW I NEED TO CAST A FRAME THAT HAS THE FOUR IMAGES ON IT
        console.log(
          "the image 1,2,3,4 are: ",
          imageOneUrl,
          imageTwoUrl,
          imageThreeUrl,
          imageFourUr
        ...
        let thisCastOptions = {
          ...
          embeds: [
            {
              url: `https://api.anky.lat/farcaster-frames/generated-anky?id=${anky.imagineApiID}&revealed=0`,
            },
          ],
